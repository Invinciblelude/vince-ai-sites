...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-56px)] items-center justify-center px-4">
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(ellipse_70%_50%_at_50%_-10%,var(--accent)/10%,transparent)]" />
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium transition-colors hover:bg-card-hover disabled:opacity-50"
        >
