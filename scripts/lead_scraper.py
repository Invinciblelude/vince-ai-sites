...
Setup:
  ...
  4. pip install -r scripts/requirements-leads.txt
  5. export GOOGLE_PLACES_API_KEY=your_key

Run:
  python scripts/lead_scraper.py --cities "Austin,Houston,Dallas" --output leads.csv
  python scripts/lead_scraper.py --cities "Austin" --types "barber_shop,beauty_salon,spa" --limit 100
"""
